...
\begin{center}
	...
	\vspace{2mm}
	{\faEnvelope\ icyph0x@protonmail.com} | {\faMobile\ 9986951911} | {\faMapMarker\ Chennai, IN} | {\faLink\ https://ph0x.me}
	\begin{center}
...
\cvsection{Summary}
\begin{center}
	Information security researcher, semi-professional penetration tester, backend web developer. I love Linux, free software and minimalism. View my projects and code at \url{https://github.com/icyphox}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     Education
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
