...
\cvsection{Summary}
\begin{center}
	Information security researcher, semi-professional penetration tester, and web developer. I love Linux, free software and open source. View my projects and code at
	\urlstyle{same}
...
\begin{cventries}
	\cventry
	{A basic implementation of Git in Nim}
	{Nit}
	{Nim}
...
\begin{cventries}
	\cventry
	{Web Security Intern}
	{Sensei Techonologies}
	{Bangalore, IN}
	{May 2018 - present}
	{\begin{cvitems}
		\item {Using Burp Suite to test web apps}
		\item {Providing solutions for mitigation of security threats}
	\end{cvitems}}
	\cventry
	{Cybersecurity}
	{WebArch}
