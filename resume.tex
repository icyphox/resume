...
radare2 \textbullet{} gdb \textbullet{}
\sectionsep
\subsection{Infrastructure}
Kubernetes (GKE) \textbullet{} Hashicorp Vault \\
...
\begin{tightemize}
\item Setting up an event driven observability pipeline (Kafka, Telegraf (statsd), InfluxDB)
\item Monitoring and alerting
\item Improving analysis security contexts
